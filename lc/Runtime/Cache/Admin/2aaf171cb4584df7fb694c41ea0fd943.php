<?php if (!defined('THINK_PATH')) exit();?>
				...
				<div id="content">
					<div id="main">
					<h1>Welcome, <span>Johnatan</span>!</h1>
					<p>今天要做些什么?</p>
						...
						<ul class="dash">
							<li>
								<a href="#" title="Write a new article" class="tooltip">
									<img src="/lcvip/Public/admincss/assets/icons/8_48x48.png" alt="" />
									<span>最新评论</span>
								</a>
							</li>
							<li>
								<a href="#" title="What your team posted" class="tooltip">
									<img src="/lcvip/Public/admincss/assets/icons/7_48x48.png" alt="" />
									<span>记得改span样式字体大小</span>
								</a>
							</li>
							<li>
								<a href="#" title="Manage users and accounts" class="tooltip">
									<img src="/lcvip/Public/admincss/assets/icons/16_48x48.png" alt="" />
									<span>用户</span>
								</a>
							</li>
							<li>
								<a href="#" title="Your site's statistics" class="tooltip">
									<img src="/lcvip/Public/admincss/assets/icons/4_48x48.png" alt="" />
									<span>统计</span>
								</a>
							</li>
							...
							<li>
								<a href="#" title="Server warnings" class="tooltip">
									<img src="/lcvip/Public/admincss/assets/icons/5_48x48.png" alt="" />
									<span>服务器警告</span>
								</a>
							</li>
							<li>
								<a href="#" title="Manage downloads" class="tooltip">
									<img src="/lcvip/Public/admincss/assets/icons/3_48x48.png" alt="" />
									<span>下载</span>
								</a>
							</li>
							<li>
								<a href="#" title="Lorem ipsum" class="tooltip">
									<img src="/lcvip/Public/admincss/assets/icons/9_48x48.png" alt="" />
									<span>表</span>
								</a>
							</li>
							<li>
								<a href="#" title="Users' photo gallery" class="tooltip">
									<img src="/lcvip/Public/admincss/assets/icons/1_48x48.png" alt="" />
									<span>画廊</span>
								</a>
							</li>
							<li>
								<a href="#" title="0 new messages" class="tooltip">
									<img src="/lcvip/Public/admincss/assets/icons/25_48x48.png" alt="" />
									<span>收件箱</span>
								</a>
							</li>
							<li>
								<a href="#" title="Browse for files" class="tooltip">
									<img src="/lcvip/Public/admincss/assets/icons/21_48x48.png" alt="" />
									<span>文件浏览器</span>
								</a>
							</li>
							<li>
								<a href="#" title="Calculator" class="tooltip">
									<img src="/lcvip/Public/admincss/assets/icons/30_48x48.png" alt="" />
									<span>计算机</span>
								</a>
							</li>
							<li>
								<a href="#" title="RSS Feeds" class="tooltip">
									<img src="/lcvip/Public/admincss/assets/icons/29_48x48.png" alt="" />
									<span>Feeds</span>
								</a>
							</li>
							<li>
								<a href="#" title="Lorem ipsum" class="tooltip">
									<img src="/lcvip/Public/admincss/assets/icons/20_48x48.png" alt="" />
									<span>媒体</span>
								</a>
							</li>
							<li>
								<a href="#" title="Lorem ipsum" class="tooltip">
									<img src="/lcvip/Public/admincss/assets/icons/26_48x48.png" alt="" />
									<span>最新评论</span>
								</a>
							</li>
						</ul>
								...
								<div id="tabs-2">
									...
									<table class="normal" cellpadding="0" cellspacing="0" border="0">
										...
										<tbody>
											<tr>
												<td>1</td>
												<td><img src="/lcvip/Public/admincss/images/1.jpg" alt="" /></td>
											...
											<tr class="odd">
												<td>2</td>
												<td><img src="/lcvip/Public/admincss/images/2.jpg" alt="" /></td>
												<td>johndoe@something.web</td>
												<td>Johnatan Doe</td>
												<td>23/01/2010</td>
											</tr>
											<tr>
												<td>3</td>
												<td><img src="/lcvip/Public/admincss/images/3.jpg" alt="" /></td>
												<td>johndoe@something.web</td>
												<td>Johnatan Doe</td>
												<td>23/01/2010</td>
											</tr>
											<tr class="odd">
												<td>4</td>
												<td><img src="/lcvip/Public/admincss/images/4.jpg" alt="" /></td>
												<td>johndoe@something.web</td>
												<td>Johnatan Doe</td>
												<td>23/01/2010</td>
											</tr>
